<template>
  <div class="page">
    ...
    <div class="columns">
      <div class="column p-10 is-one-third has-text-right">
        <button :enabled="!ready" class="button is-large is-success" @click="play()">Play!</button>
      </div>
      <div class="column p-10 is-one-third has-text-left">
        <button class="button is-large is-danger" @click="stopWebcam()">Reset</button>
      </div>
    </div>
  </div>
</template>
